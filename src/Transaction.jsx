...
function Transaction() {
  ...
  const transactions = [
    ...
    ["laptop_mac", "Freelance Work", "+₱20,000.00", "Income"],
    ["receipt_long", "Bills & Utilities", "-₱1,000.00", "Expense"],
    ["fitness_center", "Health & Fitness", "-₱999.00", "Expense"],
    ["savings", "Savings Account", "+₱20,000.00", "Income"],
  ];
